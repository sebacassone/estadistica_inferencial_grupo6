...
Como no siguen una distribución normal y los datos son muestras independientes, se usara la prueba no paramétrica "Prueba de Sumas de Rangos de Wilcoxon", ya que no se puede usar la prueba t student ni la prueba z debido a la normalidad.
...
Como nuestro p-value es menor a el nivel de significancia, podemos decir con un 95% de confianza, que se rechaza la hipotesis nula, a favor de la hipotesis alternativa, osea, al comparar las mismas instancias con iguales características, las mejores soluciones encontradas por las diferentes versiones del algoritmo tienen rendimientos distintos.
