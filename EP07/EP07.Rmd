...
datos_60ANodos <- datos %>%
  filter(n.nodos >= 60)

# Se deja solo las mediciones de el algoritmo A y C

datos_filtrados1 <- datos_60ANodos %>%
...
datos_filtrados3 <- datos_45ANodos %>%
